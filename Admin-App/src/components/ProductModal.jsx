...
const ProductModal = ({ product, onClose, onSaved, categories = [] }) => {
  ...
  useEffect(() => {
    if (product) {
      ...
      // Set available subcategories when editing
      if (product.category) {
        setAvailableSubCategories(SUB_CATEGORIES[product.category] || [])
      }
    }
  }, [product])
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'category') {
      ...
      setAvailableSubCategories(SUB_CATEGORIES[value] || [])
    } else {
      setFormData(prev => ({
        ...prev,
        [name]: value
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              >
                ...
                {categories && categories.length > 0 ? (
                  ...
                  <>
                    ...
                    <option value="Kids Tange">Kids Tange</option>
                    <option value="Stools">Stools</option>
                    <option value="Set of chair & Table">Set of chair & Table</option>
                  </>
                )}
              </select>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
              >
                <option value="">
                  {availableSubCategories.length === 0 ? 'No subcategories available' : 'Select Subcategory'}
                </option>
